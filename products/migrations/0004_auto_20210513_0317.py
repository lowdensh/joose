    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume', models.PositiveSmallIntegerField(default=10, help_text='ml', validators=[django.core.validators.MinValueValidator(10)], verbose_name='volume')),
                ('vg', models.PositiveSmallIntegerField(default=50, help_text='%', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='VG')),
        ...
        migrations.AddConstraint(
            model_name='productvariant',
            constraint=models.CheckConstraint(check=models.Q(('volume__gte', 10)), name='products_productvariant_volume_min'),
        ),
        migrations.AddConstraint(
            model_name='productvariant',
            constraint=models.CheckConstraint(check=models.Q(('vg__gte', 0), ('vg__lte', 100)), name='products_productvariant_vg_valid_range'),
        ),
        migrations.AddConstraint(
            model_name='productvariant',
            constraint=models.UniqueConstraint(fields=('product', 'volume', 'vg', 'is_salt_nic'), name='products_productvariant_prod_vol_vg_salt_unique_together'),
        ),
    ]
